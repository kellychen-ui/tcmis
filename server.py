...
@app.route("/")
def index():
    homepage = "<h1>歡迎進入陳宜琳的網站首頁</h1>"
    homepage += "<a href=/mis>課程</a><br>"
    homepage += "<a href=/today>今天日期</a><br>"
    homepage += "<a href=/about>關於宜琳</a><br>"
    homepage += "<a href=/welcome?u=宜琳&dep=靜宜資管>GET傳值</a><br>"
    homepage += "<a href=/account>POST傳值(帳號密碼</a><br>"
