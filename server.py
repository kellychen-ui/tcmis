...
def index():
    ...
    homepage += "<a href=/mis>課程</a><hr>"
    homepage += "<a href=/today>今天日期</a><hr>"
    homepage += "<a href=/about>關於宜琳</a><hr>"
    homepage += "<a href=/welcome?u=宜琳&dep=靜宜資管>GET傳值</a><hr>"
    homepage += "<a href=/account>POST傳值(帳號密碼)</a><hr>"
